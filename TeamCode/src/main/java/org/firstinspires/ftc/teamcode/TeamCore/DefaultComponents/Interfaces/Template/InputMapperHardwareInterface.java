...
public abstract class InputMapperHardwareInterface extends Interface {
    ...
    public InputMapperHardwareInterface(String name, Boolean active, TeamCore core, InterfaceType interfType) {
        super(name, active, core, interfType, ComponentType.HARDARE_INTERFACE, ComponentType.INPUT_MAPPER);
    }
