package org.firstinspires.ftc.teamcode.OldCode.TeamElementDetection.Pipeline;
...
public class SplitAveragePipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        zone1 = input.submat(new Rect(85, 180, 115, 140));
        zone2 = input.submat(new Rect(290, 180, 160, 115));
        zone3 = input.submat(new Rect(540, 180, 115, 115));
